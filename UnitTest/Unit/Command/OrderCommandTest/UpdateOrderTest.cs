...
namespace UnitTest.Unit.Command.OrderCommandTest
{
    public class UpdateOrderTest : OrderCommandTestBase
    {
        ...
        public async Task UpdateOrder_ModifyExistingItems_UpdatesItemsSuccessfully()
        {
            ...
            var existingDishId = order.Items.First().DishId;
            ...
            // ACT
            var result = await _orderCommand.UpdateOrder(updateRequest, order.Id, newPrice);
            ...
            var updatedItem = result.Items.First(i => i.DishId == existingDishId);
            ...
            savedOrder.Items.First(i => i.DishId == existingDishId).Quantity.Should().Be(5);
        }
        [Fact]
        ...
        public async Task UpdateOrder_MixAddAndModify_HandlesCorrectly()
        {
            ...
            var modifiedItem = result.Items.First(i => i.DishId == existingDishId);
